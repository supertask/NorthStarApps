Shader "SineVFX/LivingParticles/LivingParticleFloor"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 appendResult143 = (float2(appendResult17.z , appendResult17.y));
			float2 appendResult142 = (float2(appendResult17.x , appendResult17.y));
			...
			v.vertex.xyz += ( ( 1.0 - ResultMaskModified90 ) * _OffsetPower * normalizeResult139 );
		}
